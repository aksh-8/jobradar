...
| Web dashboard | Score public US job links, review resume recommendations and outreach guidance, and manage application lifecycle state | Responsive HTML, CSS, and vanilla JavaScript |
